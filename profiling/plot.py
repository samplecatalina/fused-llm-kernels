...
TRITON_PLOTS = {
    ...
    "rmsnorm_bwd": ("RMSNorm backward: one pass for both gradients beats two",
                    [("triton", "Triton, dx and dw in one pass (1 kernel)"),
                     ("native", "PyTorch fused backward (2 kernels)"),
                     ("compile", "torch.compile (2 kernels)"),
                     ("eager", "eager autograd (16 kernels)")]),
